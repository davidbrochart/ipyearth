...
module.exports['map'] = function(element) {
    ...
    require("../../topojson/1.1.0/topojson.js");
    require("../../d3/3.3.10/d3.js");
    
    require("../../d3.geo/0.0.0/d3.geo.projection.v0.min.js");
    require("../../d3.geo/0.0.0/d3.geo.polyhedron.v0.min.js");
    require("../../when/2.6.0/when.js");
